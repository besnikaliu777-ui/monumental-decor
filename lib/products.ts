...
export const products: Product[] = [
  {
    ...
    descriptions: {
      ...
      de: 'Dekorativer Brunnen mit Damenstatue, skulptiertem Becken und heller Steinoptik. Ein monumentales Stück für Halle, Villa, Wintergarten oder überdachte Terrasse.',
      it: 'Fontana decorativa con statua femminile, vasca scolpita e finitura pietra chiara. Un pezzo monumentale per hall, ville, giardini d\'inverno o terrazze coperte.',
      en: 'Decorative fountain with lady statue, sculpted basin and light stone finish. A monumental piece for a hall, villa, conservatory or covered terrace.',
    },
  ...
  },
  {
    ...
    descriptions: {
      ...
      de: 'Dekorative Vase mit Engeln, floralen Ornamenten und goldenen Details. Ideal für Eingang, Wohnraum, Empfangsbereich oder überdachte Terrasse.',
      it: 'Vaso decorativo con angeli, ornamenti floreali e dettagli dorati. Ideale per un ingresso, un salotto, una reception o una terrazza coperta.',
      en: 'Decorative angel vase with floral ornaments and gold details. Well suited to an entrance, living room, reception area or covered terrace.',
    },
  ...
  },
  {
    ...
    descriptions: {
      ...
      de: 'Grosse dekorative Vase in Steinoptik für Garten, Eingang oder Terrasse. Grosszügiges Format mit klassischen Linien und realistischer Oberfläche.',
      it: 'Grande vaso decorativo effetto pietra per giardino, ingresso o terrazza. Formato generoso con linee classiche e finitura realistica.',
      en: 'Large stone-effect decorative vase for a garden, entrance or terrace. Generous proportions with classical lines and a realistic finish.',
    },
  ...
  },
  {
    ...
    descriptions: {
      ...
      de: 'Sitzende Hundestatue mit realistischer Steinoptik. Ein markantes Stück für Villeneingang, Garten oder Terrasse.',
      it: 'Statua di cane seduto con finitura realistica effetto pietra. Un pezzo deciso per l\'ingresso di una villa, un giardino o una terrazza.',
      en: 'Seated dog statue with a realistic stone-effect finish. A strong piece for a villa entrance, garden or terrace.',
    },
    dimensions: 'Env. 95 x 72 x 48 cm',
    weight: 'Env. 30 kg',
  ...
  },
  {
    ...
    descriptions: {
      ...
      de: 'Monumentaler dekorativer Pfau mit farbigem Gefieder und realistischen Details. Ein spektakuläres Stück für Garten, Villa, Hotel oder gestalteten Eingang.',
      it: 'Pavone decorativo monumentale con piumaggio colorato e dettagli realistici. Pezzo spettacolare per giardino, villa, hotel o ingresso paesaggistico.',
      en: 'Monumental decorative peacock with colourful plumage and realistic detail. A spectacular piece for a garden, villa, hotel or landscaped entrance.',
    },
  ...
  },
  {
    ...
    descriptions: {
      ...
      de: 'Imperiale Löwenstatue mit realistischer Steinoptik. Ein monumentales Stück für Villeneingang, Terrasse, Garten oder Empfangsbereich.',
      it: 'Statua di leone imperiale con finitura effetto pietra realistica. Un pezzo monumentale per l\'ingresso di una villa, terrazza, giardino o area di accoglienza.',
      en: 'Imperial lion statue with a realistic stone finish. A monumental piece for a villa entrance, terrace, garden or reception area.',
    },
  ...
  },
  {
    ...
    descriptions: {
      ...
      de: 'Imperiale Gorillastatue in realistischer schwarzer Ausführung. Ein ausdrucksstarkes Stück für Garten, Terrasse, Hotel oder gestalteten Eingang.',
      it: 'Statua di gorilla imperiale con finitura nera realistica. Pezzo espressivo per giardino, terrazza, hotel o ingresso paesaggistico.',
      en: 'Imperial gorilla statue in a realistic black finish. An expressive piece for a garden, terrace, hotel or landscaped entrance.',
    },
